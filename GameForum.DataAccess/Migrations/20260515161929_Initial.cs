        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultGameVisibility = table.Column<int>(type: "integer", nullable: false),
                    CurrentlyPlayingGameId = table.Column<Guid>(type: "uuid", nullable: true),
                    FavoriteGameId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_Games_CurrentlyPlayingGameId",
                        column: x => x.CurrentlyPlayingGameId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HoursPlayed = table.Column<decimal>(type: "numeric(8,2)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_CurrentlyPlayingGameId",
                table: "Users",
                column: "CurrentlyPlayingGameId");
